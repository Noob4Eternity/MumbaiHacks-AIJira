...
function Index() {
  return (
    <div className="flex  min-h-screen">
      {/* Sidebar */}
      <div className="w-60 h-screen bg-white rounded-3xl shadow-lg  ml-4 p-6">
      ...
      <div className="flex-grow p-5">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-3xl shadow-lg p-6">
            <h3 className="font-semibold text-gray-700">Google Calender</h3>
            <p className="text-gray-600">Details for Schedule 1...</p>
          </div>
          <div className="bg-white rounded-3xl shadow-lg p-6">
            <h3 className="font-semibold text-gray-700">Google Drive</h3>
